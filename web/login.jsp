                            ...
                            <form action="login" method="POST">
                                <div class="row">                             
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" name="user" type="text" placeholder="Số điện thoại">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <p><button class="btn">Đăng nhập</button></p>
                                    </div>
                                </div>
                            </form>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="register.jsp" class="btn">Chuyển sang Đăng ký</a>
                                </div>
                            </div>   
                        </div>
                    </div>
