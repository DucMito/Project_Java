                                        ...
                                        <div class="checkout-inner">
                                            <div class="billing-address">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label>Ảnh</label>
                                                        <input class="form-control" type="text" name="image" value="${edit.image}" required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label>Giá tiền</label>
                                                        <input class="form-control" type="text" name="price" value="${edit.price}" required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label>Loại</label>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input class="form-control" type="text" name="des" value="${edit.description}" required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label>Nhãn hàng</label>
                                                        <input class="form-control" type="text" value="${cate.name}" readonly>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label>Mã Sản phẩm</label>
                                                        <input class="form-control" type="text" name="pid" value="${edit.productId}" readonly>
                                                    </div>
                                                </div>
                                            </div>                          
                                        </div>
                                        ...
                                        <div class="checkout-inner">
                                            <div class="checkout-payment">                                
                                                <div class="checkout-btn">
                                                    <button style="font-size: 25px" value="">Hoàn tất chỉnh sửa</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
